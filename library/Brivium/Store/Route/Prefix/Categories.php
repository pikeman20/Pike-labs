 ...
 */
class Brivium_Store_Route_Prefix_Categories implements XenForo_Route_Interface
{
	/**
	...
	public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
	{
		...
		return $router->getRouteMatch('Brivium_Store_ControllerPublic_Category', $action, 'BR_store');
	}
