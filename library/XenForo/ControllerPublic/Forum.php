...
class XenForo_ControllerPublic_Forum extends XenForo_ControllerPublic_Abstract
{
	...
	public function actionIndex()
	{
		...
		$threadLimit = XenForo_Application::getOptions()->forumListNewPosts;
		if ($threadLimit)
		{
	...
	public function actionCreateThread()
	{
		...
		$viewParams = array(
			...
			'canEditTags' => $this->_getThreadModel()->canEditTags(null, $forum),
	...
	public function actionAddThread()
	{
		...
		if ($this->_getThreadModel()->canEditTags(null, $forum))
		{
			...
			$tagger = $tagModel->getTagger('thread');
			$tagger->setPermissionsFromContext($forum)
				->setTags($tagModel->splitTags($input['tags']));
